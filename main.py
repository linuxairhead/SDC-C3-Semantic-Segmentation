...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # upsample
    layer3a_in1 = tf.layers.conv2d_transpose(layer4a_out,
                                             num_classes,
                                             4,
                                             strides= (2, 2),
                                             padding= 'same',
    ...
    layer3a_in2 = tf.layers.conv2d(vgg_layer3_out,
                                   num_classes,
                                   1,
                                   padding= 'same',
                                   kernel_initializer= tf.random_normal_initializer(stddev=0.01),
    ...
    # upsample
    nn_last_layer = tf.layers.conv2d_transpose(layer3a_out,
                                               num_classes,
                                               16,
                                               strides= (8, 8),
                                               padding= 'same',
...
def run():
	...
	# Load Layers from pre_trained VGG
